...
const CreateChatBtn = ({isLarge}: {isLarge?: boolean}) => {
    ...
    const NewChat = async() => {
        ...
        toast({
            ...
            description: 'Wait Patiently, your consultation will start soon',
            duration: 3000,
        });
        ...
        await setDoc(addchatRef(chatId, session.user.id), {
            ...
            toast({
                ...
                description: "Let's begin with your consultation",
            ...
            toast({
                ...
                description: "Please Retry for your consultation",
                variant: "destructive",
                duration: 2000,
            });
        }).finally(()=>{
