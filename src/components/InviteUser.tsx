    ...
    async function onSubmit(values:z.infer<typeof formSchema>) {
        ...
        if(!Pro && freeUsers >=2){
            toast({
                ...
                description: "You have exceeded the limit of users in a single chat for the Free plan. Please upgrade to Health Pro plan to continue adding users to chats.",
                variant: "destructive",
                action: (
                        ...
                        <Form {...form}>
                            <form onSubmit={form.handleSubmit(onSubmit)} className='flex flex-col space-y-2'>
                                <FormField control={form.control} name='email' render={({field})=>(
                                    <FormItem>
                                        <FormControl>
                                            <Input placeholder='your_consultant@mail.com' {...field}/>
                                        </FormControl>
                                    </FormItem>
                                )}/>
